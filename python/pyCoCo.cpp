...
static int __pyx_pw_6pyCoCo_6pyCoCo_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    ...
    __pyx_v_flt = __pyx_convert_string_from_py_std__in_string(values[0]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_root = __pyx_convert_string_from_py_std__in_string(values[1]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
  }
...
static PyObject *__pyx_pw_6pyCoCo_6pyCoCo_7simulate(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("simulate (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_z)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("simulate", 1, 9, 9, 1); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_absMag)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("simulate", 1, 9, 9, 2); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Ebv_MW)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("simulate", 1, 9, 9, 3); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Ebv_Host)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("simulate", 1, 9, 9, 4); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_R_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("simulate", 1, 9, 9, 5); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mjdPeak)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("simulate", 1, 9, 9, 6); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mjdSim)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("simulate", 1, 9, 9, 7); __PYX_ERR(0, 32, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_flt)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("simulate", 1, 9, 9, 8); __PYX_ERR(0, 32, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "simulate") < 0)) __PYX_ERR(0, 32, __pyx_L3_error)
      }
    ...
    __pyx_v_name = __pyx_convert_string_from_py_std__in_string(values[0]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L3_error)
    __pyx_v_z = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_z == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_absMag = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_absMag == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 35, __pyx_L3_error)
    __pyx_v_Ebv_MW = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_Ebv_MW == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_Ebv_Host = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_Ebv_Host == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L3_error)
    __pyx_v_R_v = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_R_v == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
    __pyx_v_mjdPeak = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_mjdPeak == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_mjdSim = ((PyArrayObject *)values[7]);
    __pyx_v_flt = ((PyArrayObject *)values[8]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("simulate", 1, 9, 9, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 32, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyCoCo.pyCoCo.simulate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mjdSim), __pyx_ptype_5numpy_ndarray, 0, "mjdSim", 0))) __PYX_ERR(0, 40, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_flt), __pyx_ptype_5numpy_ndarray, 0, "flt", 0))) __PYX_ERR(0, 41, __pyx_L1_error)
...
static PyObject *__pyx_pf_6pyCoCo_6pyCoCo_6simulate(struct __pyx_obj_6pyCoCo_pyCoCo *__pyx_v_self, std::string __pyx_v_name, double __pyx_v_z, double __pyx_v_absMag, double __pyx_v_Ebv_MW, double __pyx_v_Ebv_Host, double __pyx_v_R_v, double __pyx_v_mjdPeak, PyArrayObject *__pyx_v_mjdSim, PyArrayObject *__pyx_v_flt) {
  ...
  __pyx_pybuffernd_mjdSim.rcbuffer = &__pyx_pybuffer_mjdSim;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mjdSim.rcbuffer->pybuffer, (PyObject*)__pyx_v_mjdSim, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 32, __pyx_L1_error)
  }
 ...
 * 
 */
  __pyx_t_1 = __pyx_convert_vector_from_py_double(((PyObject *)__pyx_v_mjdSim)); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
 ...
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_std_3a__3a_string(((PyObject *)__pyx_v_flt)); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_mjdSim->dimensions[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_7) < 0) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
 ...
 * 
 */
  __pyx_t_7 = __pyx_convert_vector_to_py_double(__pyx_v_self->thisptr->flux_); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_res), 0, __pyx_t_7, long, 1, __Pyx_PyInt_From_long, 0, 0, 0) < 0)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 *         return res
 */
  __pyx_t_7 = __pyx_convert_vector_to_py_double(__pyx_v_self->thisptr->fluxErr_); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_res), 1, __pyx_t_7, long, 1, __Pyx_PyInt_From_long, 0, 0, 0) < 0)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_6pyCoCo_pyCoCo) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_type_6pyCoCo_pyCoCo.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "pyCoCo", (PyObject *)&__pyx_type_6pyCoCo_pyCoCo) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
